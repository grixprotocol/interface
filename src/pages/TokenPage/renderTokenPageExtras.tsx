          ...
          <StatGroup bg={cardBg} p={8} borderRadius="xl" borderWidth="1px" borderColor={borderColor} w="full">
            <SimpleGrid columns={{ base: 2, md: 2 }} spacing={8} w="full">
              <Stat>
                ...
                <StatNumber fontSize="3xl" fontWeight="bold" bgGradient="linear(to-r, blue.400, teal.400)" bgClip="text">
                  $
              ...
              <Stat>
                ...
                <StatNumber fontSize="3xl" fontWeight="bold" bgGradient="linear(to-r, teal.400, cyan.400)" bgClip="text">
              ...
              <Stat>
                ...
                <StatNumber fontSize="3xl" fontWeight="bold" bgGradient="linear(to-r, cyan.400, blue.400)" bgClip="text">
              ...
              <Stat>
                ...
                <StatNumber fontSize="3xl" fontWeight="bold" bgGradient="linear(to-r, purple.400, blue.400)" bgClip="text">
...
export const renderIntegratedProtocolsSection = ({ cardBg, borderColor }: SectionProps) => (
  <section aria-label="Integrated Protocols">
    <VStack spacing={10} align="center">
      <Heading fontSize={{ base: '2xl', md: '3xl' }} textAlign="center" bgGradient="linear(to-r, blue.400, blue.600)" bgClip="text">
        Integrated Protocols
      </Heading>
      ...
      <Box bg={cardBg} p={8} borderRadius="xl" borderWidth="1px" borderColor={borderColor} w="full" maxW="1200px">
        <SimpleGrid columns={{ base: 2, md: 5 }} spacing={8}>
          {['Hyperliquid', 'Powertrade', 'Deribit', 'GMX', 'Premia', 'Rysk', 'Aevo', 'Derive', 'Itacha', 'Zomma'].map((protocol, index) => (
            <MotionBox
              key={protocol}
              p={5}
              borderRadius="lg"
