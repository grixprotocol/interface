...
import { ForDevelopersSection, ForTradersSection } from '@/pages/TokenPage/components/TokenPageSections';
...
export const TokenPage = () => {
  ...
  const { data: grixMetrics } = useGrixMetrics();
  ...
  return (
    <>
      ...
      <Container maxW="1400px" py={{ base: 24, md: 32, lg: 36 }} px={{ base: 4, md: 8 }} position="relative">
        <VStack spacing={{ base: 28, md: 32, lg: 36 }} align="stretch">
            ...
            <VStack spacing={12} align="center">
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={8} w="full" maxW="1200px">
                ...
                >
                  <VStack spacing={6} align="center" textAlign="center">
                    <Heading size="lg" fontWeight="800">
                      ...
                      <Text as="span" bgGradient="linear(to-r, green.200, teal.200)" bgClip="text">
                        Trading Interface
                      </Text>
                    </Heading>
                ...
                >
                  <VStack spacing={6} align="center" textAlign="center">
                    <Heading size="lg" fontWeight="800">
                      <Text as="span" color="purple.200" fontSize="2xl" mr={2}>
                        🤖
                      </Text>
                      <Text as="span" bgGradient="linear(to-r, purple.200, pink.200)" bgClip="text">
                        AI Agent Playground
                      </Text>
                    </Heading>
                    <Text color="white" fontSize="lg">
                    ...
                    <ActionButton
                      href="https://app.grix.finance/calypso/lobby"
                      onClick={() => track('ai_agent_playground_click')}
                      size="md"
                    >
                      Start Building
                    </ActionButton>
          ...
          <section aria-label="Network Availability">
            <VStack spacing={8} align="center">
              ...
              <NetworkAvailability cardBg={cardBg} cardHoverBg={cardHoverBg} borderColor={borderColor} />
            </VStack>
          </section>
